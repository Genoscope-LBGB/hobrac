...
rule gen_dgenies_index:
    ...
    shell:
        ...
        dotplotrs -m 2000 -p aln.paf -o dotplot_{params.assembly_prefix}_vs_{wildcards.accession}.png --line-thickness 4 --dump-significance significance_results.txt
        dotplotrs -m 2000 -p aln.paf -o dotplot_{params.assembly_prefix}_vs_{wildcards.accession}_bw.png --line-thickness 4 --no-color
    """
